...
public class RoomDtos
{
    ...
    public static class RoomStatusDto
    {
        ...
        private List<AnswerComparisonDto> answerComparisons; // Store comparisons for each question

        public RoomStatusDto()
        {
        }

        public List<AnswerComparisonDto> getAnswerComparisons()
        {
            return answerComparisons;
        }
        ...
        public void setAnswerComparisons(List<AnswerComparisonDto> answerComparisons)
        {
            this.answerComparisons = answerComparisons;
        }
